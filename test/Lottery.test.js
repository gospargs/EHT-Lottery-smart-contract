...
describe('Lottery Contract', () => {
  ...
  it('allows one account to enter', async () => {
    await lottery.methods.enter().send({
      from: accounts[0],
      value: web3.utils.toWei('0.02', 'ether'), // converter to ether
    });
  ...
  // testing that if someone does not send enough ether it fails, assert(error) - error is present
  ...
  it('players list has been emptyed out',async()=>{
